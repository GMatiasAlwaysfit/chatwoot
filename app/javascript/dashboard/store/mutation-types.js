export default {
  ...
  // Tabulations
  SET_TABULATION_UI_FLAG: 'SET_TABULATION_UI_FLAG',
  SET_TABULATION: 'SET_TABULATION',
  ADD_TABULATION: 'ADD_TABULATION',
  EDIT_TABULATION: 'EDIT_TABULATION',
  DELETE_TABULATION: 'DELETE_TABULATION',
